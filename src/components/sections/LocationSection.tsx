      ...
      <Container>
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="relative h-[400px] lg:h-[500px] rounded-md overflow-hidden shadow-xl"
          >
            ...
            >
              <div className="relative">
                <div className="w-12 h-12 bg-brand-sage rounded-full flex items-center justify-center shadow-lg">
                  <MapPin size={24} className="text-white" />
                </div>
                <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-3 h-3 bg-brand-sage rotate-45" />
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-card rounded-md border border-border">
                <div className="w-10 h-10 rounded-full bg-brand-sage/10 flex items-center justify-center flex-shrink-0">
                  <MapPin size={20} className="text-brand-sage" />
                </div>
                <div>
                  <h4 className="font-sans font-medium text-foreground">Adres</h4>
              ...
              <div className="flex items-start gap-4 p-4 bg-card rounded-md border border-border">
                <div className="w-10 h-10 rounded-full bg-brand-sage/10 flex items-center justify-center flex-shrink-0">
                  <Phone size={20} className="text-brand-sage" />
                </div>
                <div>
                  <h4 className="font-sans font-medium text-foreground">Telefoon</h4>
                  <p className="font-sans text-sm text-muted-foreground">
                    +32 (0)XX XXX XX XX
                  </p>
                </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-card rounded-md border border-border">
                ...
                <div>
                  <h4 className="font-sans font-medium text-foreground">E-mail</h4>
                  <p className="font-sans text-sm text-muted-foreground">
